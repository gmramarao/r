  ...
  // Post user location
    PostUserLocation(user_location_object) {
      ...
      const header = new Headers();
        ...
        return this.http.post('https://api.reatchall.com/user/post-user-location', user_location_object, { headers: header }).map(res => res.json());
    }
    ...
    postOrder(order) {
      ...
      return this.http.post('https://api.reatchall.com/user/post-order', order, { headers: header }).map(res => res.json());
    }
    ...
    postReview(review_obj) {
      ...
      return this.http.post('https://api.reatchall.com/user/post-review', review_obj, { headers: header }).map(res => res.json());
    }

    // Get terms for terms and conditions page
    getTerms() {
      // return this.http.get('http://localhost:3000/user/get-terms').map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/get-terms').map(res => res.json());
    }
    // Get privacy policy
    getPrivacyPolicy() {
      // return this.http.get('http://localhost:3000/user/privacy-policy').map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/privacy-policy').map(res => res.json());
    }

    // Get careers cms
    getCareersCMS() {
      // return this.http.get('http://localhost:3000/user/careers-cms').map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/careers-cms').map(res => res.json());
    }
    // Get vendor policy
    getVendorPolicy() {
      // return this.http.get('http://localhost:3000/user/vendor-policy').map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/vendor-policy').map(res => res.json());
    }
    getAbout() {
      // return this.http.get('http://localhost:3000/user/get-about').map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/get-about').map(res => res.json());
    }
    updateTotalSiteVisits() {
      // return this.http.get('http://localhost:3000/user/update-site-visits').map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/update-site-visits').map(res => res.json());
    }
    getMainCats() {
      // return this.http.get('http://localhost:3000/user/get-main-cats').map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/get-main-cats').map(res => res.json());
    }
    getAllBusinesses() {
      // return this.http.get('http://localhost:3000/user/get-all-businesses').map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/get-all-businesses').map(res => res.json());
    }
    ...
    getBusinessStatus(b_id) {
      ...
      return this.http.get('https://api.reatchall.com/user/get-business-status/' + b_id).map(res => res.json());
    }
    ...
    getCatfromCatId(cat_id) {
      ...
      return this.http.get('https://api.reatchall.com/user/get-cat-from-id/' + cat_id).map(res => res.json());
    }
    // Get Business by id
    getBusinessById(b_id) {
      // return this.http.get('http://localhost:3000/user/get-business-by-id/' + b_id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/get-business-by-id/' + b_id).map(res => res.json());
    }
    // Post Custom Order
    postCustomOrder(order) {
      ...
      return this.http.post('https://api.reatchall.com/user/post-custom-order', order, { headers: header }).map(res => res.json());
    }
    postVisitToBusiness(visit_obj) {
      ...
      return this.http.post('https://api.reatchall.com/user/post-visit-to-business', visit_obj, { headers: header }).map(res => res.json());
    }
    ...
    getListsOfBusiness(b_id) {
      ...
      return this.http.get('https://api.reatchall.com/user/get-lists-of-business/' + b_id).map(res => res.json());
    }

    // Get all items of list
    getItemsOfList(l_id) {
      // return this.http.get('http://localhost:3000/user/get-items-of-list/' + l_id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/get-items-of-list/' + l_id).map(res => res.json());
    }
    ...
    getItemsOfBusiness(b_id) {
      ...
      return this.http.get('https://api.reatchall.com/user/get-items-of-business/' + b_id).map(res => res.json());
    }
    ...
    checkBusinessInWishlist(obj) {
      ...
      return this.http.post('https://api.reatchall.com/user/check-business-in-wishlist', obj, { headers: header }).map(res => res.json());
    }
    // Add to wishlist
    addBusinessInWishlist(obj) {
      ...
      return this.http.post('https://api.reatchall.com/user/add-business-to-wishlist', obj, { headers: header }).map(res => res.json());
    }
    ...
    removeBusinessInWishlist(obj) {
      ...
      return this.http.post('https://api.reatchall.com/user/remove-business-in-wishlist', obj, { headers: header }).map(res => res.json());
    }
    ...
    getUserBusinessWishlist(user_id) {
      ...
      // return this.http.get('http://localhost:3000/user/get-user-business-wishlist/' + user_id).map(res => res.json());
      // return this.http.get('http://localhost:3000/user/get-user-business-wishlist/' + user_id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/get-user-business-wishlist/' + user_id).map(res => res.json());
    }
    // Get item wishlist
    getUserItemWishlist(user_id) {
      // return this.http.get('http://localhost:3000/user/get-user-item-wishlist/' + user_id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/get-user-item-wishlist/' + user_id).map(res => res.json());
    }
    ...
    addItemToCart(obj) {
      ...
      return this.http.post('https://api.reatchall.com/user/add-to-user-cart', obj, { headers: header }).map(res => res.json());
    }
    ...
    removeItemFromCart(obj) {
      ...
      return this.http.post('https://api.reatchall.com/user/remove-from-cart', obj, { headers: header }).map(res => res.json());
    }
    getCart(user_id) {
      // return this.http.get('http://localhost:3000/user/get-cart/' + user_id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/get-cart/' + user_id).map(res => res.json());
    }
    getFeaturedBusinesses() {
      // return this.http.get('http://localhost:3000/user/get-featured-businesses').map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/get-featured-businesses').map(res => res.json());
    }
    // Get category from name
    getCatFromName(name) {
      // return this.http.get('http://localhost:3000/user/get-cat-from-name/' + name).map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/get-cat-from-name/' + name).map(res => res.json());
    }

    getSubCatsOfCat(cat_id) {
      // return this.http.get('http://localhost:3000/user/get-sub-cats-of-cat/' + cat_id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/user/get-sub-cats-of-cat/' + cat_id).map(res => res.json());
    }
}
