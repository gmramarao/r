...
export class VendorService {
    ...
    getVendorBusinesses(vendor_id) {
      ...
      return this.http.get('https://api.reatchall.com/vendor/get-vendor-businesses/' + vendor_id).map(res => res.json());
    }
    // Add new business
    addBusiness(add_business_obj) {
      ...
      return this.http.post('https://api.reatchall.com/vendor/add-business', add_business_obj, { headers: header }).map(res => res.json());
    }
    getVendorById(vendor_id) {
      // return this.http.get('http://localhost:3000/vendor/get-vendor-by-id/' + vendor_id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/vendor/get-vendor-by-id/' + vendor_id).map(res => res.json());
    }
    getBusinessById(id) {
      // return this.http.get('http://localhost:3000/vendor/get-business-by-id/' + id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/vendor/get-business-by-id/' + id).map(res => res.json());
    }
    ...
    postBusinessStatus(b_status_obj) {
      ...
      return this.http.post('https://api.reatchall.com/vendor/post-business-status', b_status_obj, { headers: header }).map(res => res.json());
    }
    // Business open/close status
    getBusinessStatus(b_id) {
      // tslint:disable-next-line:max-line-length
      // return this.http.get('http://localhost:3000/vendor/get-business-status/' + b_id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/vendor/get-business-status/' + b_id).map(res => res.json());
    }
    ...
    postBusinessProducts(b_items_obj) {
      ...
      return this.http.post('https://api.reatchall.com/vendor/post-bu', b_items_obj, { headers: header }).map(res => res.json());
    }
    ...
    postBusinessServices(b_services_obj) {
      ...
      return this.http.post('https://api.reatchall.com/vendor/post-order', b_services_obj, { headers: header }).map(res => res.json());
    }
    ...
    postBusniessOffers(b_offers_obj) {
      ...
      return this.http.post('https://api.reatchall.com/vendor/post-order', b_offers_obj, { headers: header }).map(res => res.json());
    }
    ...
    postBusniessLogo(logo_obj) {
      ...
      return this.http.post('https://api.reatchall.com/vendor/post-order', logo_obj, { headers: header }).map(res => res.json());
    }
    // Posting business Logo
    postBusniessBannerImages(banner_imgs_obj) {
      ...
      return this.http.post('https://api.reatchall.com/vendor/post-order', banner_imgs_obj, { headers: header }).map(res => res.json());
    }
    // Get all categories
    getCategories() {
      // return this.http.get('http://localhost:3000/vendor/get-all-categories').map(res => res.json());
      return this.http.get('https://api.reatchall.com/vendor/get-all-categories').map(res => res.json());
    }
    // Get All Categories
    getSubCategoriesOfCat(cat_id) {
      // return this.http.get('http://localhost:3000/vendor/get-sub-cats-of-cat/' + cat_id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/vendor/get-sub-cats-of-cat/' + cat_id).map(res => res.json());
    }
    ...
    getTotalBusinessVisits(b_id) {
      ...
      return this.http.get('https://api.reatchall.com/vendor/get-total-business-visits/' + b_id).map(res => res.json());
    }
    ...
    getTotalBusinessOrders(b_id) {
      ...
      return this.http.get('https://api.reatchall.com/vendor/get-total-business-orders/' + b_id).map(res => res.json());
    }
    ...
    getTotalNumberOfItemsOfBusiness(b_id) {
      ...
      return this.http.get('https://api.reatchall.com/vendor/get-number-of-items-of-business/' + b_id).map(res => res.json());
    }
    ...
    getListsOfBusiness(b_id) {
      ...
      return this.http.get('https://api.reatchall.com/vendor/get-lists-of-business/' + b_id).map(res => res.json());
    }

    // Get lists of business
    getItemsOfBusiness(b_id) {
      // return this.http.get('http://localhost:3000/vendor/get-items-of-business/' + b_id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/vendor/get-items-of-business/' + b_id).map(res => res.json());
    }
    ...
    addItemToBusiness(item_obj) {
      ...
      return this.http.post('https://api.reatchall.com/vendor/post-item', item_obj, { headers: header }).map(res => res.json());
    }
    addListToBusiness(list_obj) {
      ...
      return this.http.post('https://api.reatchall.com/vendor/post-list', list_obj, { headers: header }).map(res => res.json());
    }
    getListDetails(list_id) {
      // return this.http.get('http://localhost:3000/vendor/get-list-details/' + list_id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/vendor/get-list-details/' + list_id).map(res => res.json());
    }
    getListItems(list_id) {
      // return this.http.get('http://localhost:3000/vendor/get-items-of-list/' + list_id).map(res => res.json());
      return this.http.get('https://api.reatchall.com/vendor/get-items-of-list/' + list_id).map(res => res.json());
    }
}
